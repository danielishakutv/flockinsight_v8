...
export const PLANS: Plan[] = [
  ...
  },
  {
    ...
    features: [
      ...
      "Virtual meetings — video, audio, screen sharing and scripture on screen, straight from a browser. Built for weak connections, with a one-tap audio-only mode",
  ...
  },
  {
    ...
    features: [
      ...
      "Record your meetings and keep them in the media library",
